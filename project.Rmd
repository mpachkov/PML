...
The report provides results of building prediction method for predicting the manner of physical activity detected by wearable gadgets.
...
```
- Training set `r dim(training)`
- Testing set `r dim(testing)`
...
Accuracy is 0.5490259 which does not look promising.  
...
- in-sample error 1 - accuracy = 0.45
